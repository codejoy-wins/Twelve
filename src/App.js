...
function App() {
  return (
    ...
    <div id="image8"></div>
    <h2>Infoverse</h2>
    <p> Sometimes I think about how I would invent a forcefield. I do this not because I think I can, but as a way to get my thought process into a productive state. I concluded that in order to build the type of device I had in mind, it would be information based. It would be information trickery, or hacking of reality.
    ...
    I guess this is what happens when you major in philosophy.</p>

    <div id="image12"></div>
    <h2>Godlike</h2>
    <p>Starting a new project in a game engine is like starting a new universe as God. I decide where the floor goes, if there is one at all. I decide what players there are and what physics bind them.
    ...
    <a href="http://www.maxjann.com">Jann Software</a>
    </div>
  );
}
